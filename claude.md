...
#### バックアップブランチ
重要なマイルストーン到達時にバックアップを作成する際の命名規則：

**形式**: `backup-{元ブランチ名}-YYYYMMDD-{番号}`

**例**:
- `backup-feature-articleCreation-20250802-01`: feature-articleCreationブランチの2025年8月2日1回目バックアップ
- `backup-main-20250802-01`: mainブランチの2025年8月2日1回目バックアップ
...
│            │   └── diagrams/
│            └── reviews/                       # レビュー事項
├── personas/                                   # 👥 ペルソナ管理ディレクトリ（マルチロール対応）
│   ├── unified-persona-template.md            # 統合ペルソナテンプレート
│   ├── individuals/                            # 統合ペルソナ（一人格複数役割）
│   │   ├── tanukichi.md                        # たぬきち（AI技術系・皮肉ライター）
│   │   └── (その他の統合ペルソナ)
│   ├── roles/                                  # 役割別共通行動パターン
│   │   ├── author-behaviors.md                # 執筆者共通行動パターン
│   │   ├── reader-behaviors.md                # 読者共通行動パターン
│   │   ├── reviewer-behaviors.md              # レビュワー共通行動パターン
│   │   └── proofreader-behaviors.md           # 校正者共通行動パターン
│   └── contexts/                               # 状況別行動パターン
│       ├── technical-writing.md               # 技術記事コンテキスト
│       └── tutorial-writing.md                # チュートリアルコンテキスト
├── assets/                                     # 共有リソース
├── internal/                                   # スクリプト・メモ
